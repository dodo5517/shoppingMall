...
<div class="row mx-1 justify-content-center">
	...
	<h4 class="m-0 mb-3">FAQ</h4>
		...
		<table class="table table-sm table-bordered myfs12">
			<tr height="40">
				<td width="15%" class="bg-light">글제목</td>
				<td align="left" class="ps-2">
					<input type="text" name="title" size="80" value="<?=$row["title"];?>" class="form-control form-control-sm myfs12">
				</td>
			</tr>
			<tr>
				<td width="15%" class="bg-light">글내용</td>
				<td align="left" class="ps-2">
						<textarea name="contents" rows="7" cols="80" class="form-control form-control-sm my-1 myfs12"><?=$row["contents"];?></textarea>
				</td>
			</tr>
		</table>
