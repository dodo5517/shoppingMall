			...
			<tr>
				...
				<td align="left" class="px-2">
					<div class="d-inline-flex">
						<input type="text" name="title" size="85" value="<?=$title=stripslashes($row["title"]);?>" 
			...
			<tr>
				...
				<td align="left" class="p-2">
					<textarea name="contents" rows="10" cols="85" 
						class="form-control form-control-sm p-2"><?$contents=stripslashes($row["contents"]); echo $contents=nl2br($contents);?></textarea>
				</td>
			</tr>
		</table>
